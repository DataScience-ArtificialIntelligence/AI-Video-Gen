        ...
        <div className="space-y-6">
          ...
          {!loading && (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={numSlides}
                    onChange={(e) =>
                      setNumSlides(parseInt(e.target.value) || 5)
                    }
                    min="3"
                    max="10"
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-purple-500 focus:outline-none transition-colors"
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <p className="text-xs text-gray-500 text-center">
                  💡 <strong>Tip:</strong> Be specific with your topic for
                  better results. For example: "Explain photosynthesis in
                  plants" instead of just "photosynthesis"
                </p>
              </div>
            </>
          )}
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 text-center">
                Please wait while we create your video. This process may take
                several minutes.
              </p>
              <p className="text-gray-500 text-sm mt-3">
                Check your backend console for detailed progress logs.
